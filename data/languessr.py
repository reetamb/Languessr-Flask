...
nonpulmonic = "ɓ ɗ ᶑ ʄ ɠ ʛ ! ǀ ǂ ʘ ǁ".split(" ")

labial = "p b m ɱ ɸ β ʙ ⱱ ʋ v f w ʍ ʘ ɓ".split(" ")
coronal = "t d s z θ ð ʃ ʒ n r ɹ ɾ l ɬ ɮ ɺ ɫ ɗ ! ǁ ǀ ᴅ R N".split(" ")
...
front = "a ɶ æ ɛ œ e ø ɪ ʏ i y".split(" ")
central = "ɨ ʉ ɜ ɵ ə ɚ ɘ ɞ ɐ".split(" ")
        ...
        for lang in languages:
            ...
            for phone in phones:
                ...
                if phone not in classification.keys():
                    ...
                    elif phone[ind] in nonpulmonic: moa = "non-pulmonic"
